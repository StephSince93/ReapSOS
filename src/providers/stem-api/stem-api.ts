...
export class StemApiProvider {
  //api urls will change according to which build is being tested
      ...
      //private apisubmitFormUrl:string = 'https://sandbox.stemsoftware.com/api.php?action=SaveASIsafetyform';
      private apisubmitFormUrl:string = 'http://10.0.0.21/api.php?action=SaveDevonianform';
      //private apiGetUrl:string = 'https://sandbox.stemsoftware.com/api.php?action=GetDeovonianData';
      ...
      private apiUpdateGPSUrl:string = 'https://10.0.0.21.stemsoftware.com/api.php?action=DevonianGPSUpdate';
